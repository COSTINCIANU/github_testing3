...
//routeur
switch ($path) {
    case '/github_testing/github_testing3/':
        include './home.php';
        break;
    case '/github_testing/github_testing3/addUser':
        $utilCtrl->insertUser();
        break;
    case '/github_testing/github_testing3/test':
        include './test.php';
        break;
    case '/github_testing/github_testing3/api/addTest':
        $apiTestsCtrl->addTestsToJson();
        break;
    case 'github_testing/github_testing3/addTest':
